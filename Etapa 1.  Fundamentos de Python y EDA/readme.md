...
Aquí encontrarás los cuadernos organizados cronológicamente o por tema. Cada `notebook` está diseñado para ser una unidad de aprendizaje autónoma, con explicaciones claras, código comentado y resultados visibles.
...
* `[Nombre del Siguiente Cuaderno].ipynb`: Uniones de DataFrames, cómo combinar información de diferentes fuentes.
* `[Nombre del Siguiente Cuaderno].ipynb`: Ejercicios de limpieza de datos: manejando datos faltantes y errores comunes.
